...
So, without further ado, this post will demonstrate how the tidyverse, pipelearner, and twidlr can work seamlessly together to make tidy machine learning and modelling a breeze!
...
pl <- pl %>% 
  mutate(alpha     = map_dbl(params, "alpha"),
         ...
         rsquared  = map2_dbl(true, predicted, rmse))

# Plot
ggplot(pl, aes(factor(alpha), rsquared)) +
