...
[\@drsimonj](https://twitter.com/drsimonj) here to share my big takeaways from [rstudio::conf](https://www.rstudio.com/conference/), held 2017 in Kissimmee, Florida. My goal here is to share the broad opinions and challenges that I feel bring together the R community right now, and perhaps offer some guidance to anyone wanting to get into the R community.

**DISCLAIMER**: this is based on my experience, my primary interests, the talks I attended, the people I met, etc. I'm also very jet lagged after flying back to Australia! So please don't read this and think that's all there is. If you think I've missed something critical (which I'm sure I have), please comment in whichever medium (Twitter, Facebook, etc.) and get the discussion going!
...
<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Here are my slides from <a href="https://twitter.com/hashtag/rstudioconf?src=hash">#rstudioconf</a>: &quot;Opinionated Analysis Development&quot; &amp;/or &quot;Trying to Make Fetch Happen&quot; <a href="https://t.co/TLNrmUzW4M">https://t.co/TLNrmUzW4M</a></p>&mdash; Hilary Parker (@hspter) <a href="https://twitter.com/hspter/status/820354490553552897">January 14, 2017</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

To crudely (and probably inaccurately) summarize, Hilary was advocating that we focus on defining opinions about processes (like "we should be using version control") and then push for software that supports them. I liked this idea and will do my best to discuss the conference themes in this way.
...
So, what were some of the broad opinions and challenges that the R community discussed?

## Write code for humans

A big theme was how we make our code better for humans. How do we write code that people can instantly understand? This doesn't mean communicating how every function works. Rather, if I share my code with someone, can they easily get a sense of what various chunks are doing? This means less time trying to interpret code and minimizing the chance of making errors along the way.

If that is the community's opinion, their software of choice for writing human-friendly code most definitely reside in the [tidyverse](http://tidyverse.org/). It's not just the functions, but it's the philosophy behind the tidyverse that makes them so apt for writing readable code. This was evident from the start when [Hadley Wickham](https://twitter.com/hadleywickham) gave an opening keynote on the topic.

<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">.<a href="https://twitter.com/hadleywickham">@hadleywickham</a> kicking off <a href="https://twitter.com/hashtag/rstudioconf?src=hash">#rstudioconf</a> by talking about the tidyverse: both the packages and the connections between them <a href="https://twitter.com/hashtag/rstats?src=hash">#rstats</a> <a href="https://t.co/r7WztkrFBO">pic.twitter.com/r7WztkrFBO</a></p>&mdash; David Robinson (@drob) <a href="https://twitter.com/drob/status/819908216339525632">January 13, 2017</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
Another big theme surrounding the optimization of time and reduction of errors was to use proper version control. Accurately tracking how our code evolves and being able to share that evolution with others (or our future selves) is critical. Without version control, simple mistakes like mislabelling a file can have devastating consequences.

Without a doubt, the R community's software of choice for version control and sharing/developing code are Git and GitHub. You'll find that most of the top R packages are now hosted on GitHub, which enables good version control as well as an open environment that is easy for multiple people to work in at the same time. [Jenny Bryan](https://twitter.com/JennyBryan) gave a notable tutorial on this topic.

<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">I&#39;m teaching Git/GitHub today at <a href="https://twitter.com/hashtag/rstudioconf?src=hash">#rstudioconf</a>. I take a lot of inspiration from <a href="https://twitter.com/alicebartlett">@alicebartlett</a>&#39;s &quot;Git for humans&quot; <a href="https://t.co/hwjIvFZHBk">https://t.co/hwjIvFZHBk</a></p>&mdash; Jenny Bryan (@JennyBryan) <a href="https://twitter.com/JennyBryan/status/820255475098849281">January 14, 2017</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">ICYMI, &#39;nother great <a href="https://twitter.com/drsimonj">@drsimonj</a> how-to: “Easy machine learning pipelines with pipelearner” <a href="https://t.co/SS3GDjEHZ1">https://t.co/SS3GDjEHZ1</a> <a href="https://twitter.com/hashtag/rstats?src=hash">#rstats</a> <a href="https://twitter.com/hashtag/machinelearning?src=hash">#machinelearning</a> <a href="https://t.co/5vnTR0kwpG">pic.twitter.com/5vnTR0kwpG</a></p>&mdash; Mara Averick (@dataandme) <a href="https://twitter.com/dataandme/status/819742991858405377">January 13, 2017</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

However, pipelearner is far from what we need as a community. An exciting prospect is that [Max Kuhn](https://github.com/topepo), creator of the [caret](http://topepo.github.io/caret/index.html) package, has joined RStudio. We can only hope that he'll be focussing on this problem and we'll be seeing some proper opinions and tools soon.

## Visual communication is important

It's not sufficient to do an analysis. You have to present that analysis to someone! That someone could be anything from a fellow data scientist to someone who knows nothing about statistics or programming! To this end, the community opinion seems to be that we should always be presenting our workflow and findings in a visual format that is easy and enjoyable for people digest. To me, *enjoyable* is an important aspect. The details of data science work can be boring to most people. Presenting information so that people want to engage with it can make a big difference.
...
Speaking of emails, here comes my sign off and contact details...
