...
[@drsimonj](https://twitter.com/drsimonj) here to share my big takeaways from [rstudio::conf](https://www.rstudio.com/conference/), held 2017 in Kissimmee, Florida. My aim here is to share the broad data science opinions and challenges that I feel bring together the R community right now, and perhaps offer some guidance to anyone wanting to get into the R community.
...
Data science (whatever that is exactly) is hot and everyone agrees that we should model data in a way that is valid and useful. But the process by which we carry out modelling is still poorly defined and a major challenge when you consider human biases. This was really emphasised by data journalist, [Andrew Flowers](https://twitter.com/andrewflowers).
