...
Ever wondered who contributes to git repos? How their contributions have changed over time? What sort of conventions different authors use in their commit messages? Maybe you've contributed to a [tidyverse](https://www.tidyverse.org/) project after following [Mara Averick](https://twitter.com/dataandme)'s [advice](https://www.rstudio.com/resources/videos/contributing-to-tidyverse-packages/) and wonder how you fit in?
