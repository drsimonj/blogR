...
`fashion()` will now try to work on almost any object (not just correlation data frames). It also provides custom arguments to adjust the number of `decimals`, whether to display `leading_zeros`, and how to print missing values (`na_print`):
