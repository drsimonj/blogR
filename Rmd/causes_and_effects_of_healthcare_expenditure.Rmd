...
Other than being a powerful data vizualisation, what caught my attention was that Mr Gates said, "Here's a great investment". To me, this implies that by investing in healthcare, we can hope to reduce child mortality rates.

This is a tempting thought -- that changes in healthcare expenditure are **causing** some of the changes in child mortality rates, most likley through indirect means such as providing more funds to hire hospital staff. However, the OurWorldInData.org team don't claim this. Instead, they refer to child mortality as a "correlate" of healthcare expenditure. Why? Because any good scientist or statistician will remind you that "correlation does not imply causation". If you're not familiar with this concept, or feel like a laugh, [this site](https://www.fastcodesign.com/3030529/infographic-of-the-day/hilarious-graphs-prove-that-correlation-isnt-causation/5) provides some nice examples of variables that correlate but don't cause one another. Still, correlation is an important indicator of a causal relation.

## Temporal precedence as an indicator of causality

The aim of this post is to provide some empirical support for Mr Gates' comment and investigate whether there is evidence of a second indicator of causality: temporal precendence. A cause should always come before an effect in time. Therefore, should a causal link exist, past changes in healthcare expenditure should correspond to future changes in child mortality rates.

Imagine, for example, two countries that are identical in every way. One year (we'll call this year 0), one country increases the amount it is spending on healthcare, but the other country does not. What would we expect to see? If there's a causal link, then we should expect that the rates of child mortality will, over time, become lower in the country that increased its spending. This hypothesis can be visualised below.
...
What happens if we overlay information about healthcare expenditure changes in 1996 instead of world region information? This time, the thick bands represent the average for countries that did, or did not, increase their spending on health in 1996.
...
d %>% 
  ...
  labs(
    title = "Child mortality declined faster for\ncountries investing in healthcare in 1996",
    x = NULL,
    y = "Child mortality as change relative to 1996",
    color = "Increased healthcare\nexpenditure in 1996?"
  )
...
This Figure starts to looks like our hypothesised results from earlier. A gap in child mortality opens between those countries that increased their spending on healthcare in 1996 and those that did not. This indicates that future child mortality is lower for countries that increased their healthcare expenditure, and this difference is largest after around 10 years (in 2006).
...
d %>%
  ...
  labs(
    title = "Child mortality declines faster when countries invest in healthcare",
...
There seems to be a consistent difference in the future child mortality rates of countries that do or do not increase their healthcare expenditure in a given year. Furthermore, this difference continues to grow up to 10 years into the future! This provides evidence of temporal precendece and, therefore, further indicates that changes in healthcare expenditure cause or lead to changes in child mortality rates. It seems intuitive, but this provides empirical evidence to support Mr Gates' claim that, indeed, investing in healthcare can help to reduce child mortality rates and is certainly worthwhile!

## Final remarks and limitations

At the beginning I mentioned that this post is to be treated as an exercise in R and the new ourworldindata package. I'd like to mention this point again. The work produced here has not been peer-reviewed, nor have the analyses been replicated or validated by others. Therefore, for any readers who are particularly concerned with the subject-matter of this post, I'd ask that you consider doing independent work before jumping to conclusions. Similarly, if you have any idea to add here, or relevant work to reference, please contact me.
