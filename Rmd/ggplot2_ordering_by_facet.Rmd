...
Before publishing this post, I sent a draft to Julia and David for comments. First, my sincerest thanks to them for taking the time to read it!

David also made the great suggestion to encapsulate this method into a function or add a new "stat" option to `geom_bar` to handle this automatically. I'll be opening an issue about this on the [ggplot2 GitHub page](https://github.com/tidyverse/ggplot2/issues) and playing around the see what works best.
